;try{window.performance.mark('com.pyxis.greenhopper.jira,jira.webresources,jira.webresources,jira.webresources,com.atlassian.administration.atlassian-admin-quicksearch-jira,jira.webresources,com.atlassian.jira.plugins.jira-development-integration-plugin,com.atlassian.jira.jira-fileviewer-plugin,com.atlassian.jira.jira-fileviewer-plugin,com.atlassian.jira.jira-issue-nav-plugin,com.atlassian.crowd.user-provisioning-vertigo-plugin,com.atlassian.pas,com.atlassian.auiplugin,com.atlassian.jira.plugins.jira-development-integration-plugin,com.pyxis.greenhopper.jira_batch_file_eval:start');} catch(e){};;
...
require([
    ...
    Shifter.register(function () {
        ...
        // TODO Should be removed when cleaning up FF blueshift.admin.move-system-config-page-to-spa_biq80 and use formatResponseSPA instead
        ...
        var isSPASystemConfigurationEnabled = FeatureManager.isFeatureEnabled('blueshift.admin.move-system-config-page-to-spa_biq80');
...
"use strict";require(["jira/skate","jquery"],function(e,t){var i="wrc!com.atlassian.jira.plugins.jira-development-integration-plugin:devsummarycf-resources";e("fusion-devsummary-cf",{type:e.type.CLASS,created:function(e){WRM.require([i],function(){var i=require("jira-development-status/customfields/dev-summary-custom-field-column-view"),r=require("jira-development-status/component/tooltip"),o=t(e);new i({el:o}),r.tipsify({selector:".fusion-widget-tooltip",context:o,html:!0})})}})});;;try{window.performance.mark('com.pyxis.greenhopper.jira,jira.webresources,jira.webresources,jira.webresources,com.atlassian.administration.atlassian-admin-quicksearch-jira,jira.webresources,com.atlassian.jira.plugins.jira-development-integration-plugin,com.atlassian.jira.jira-fileviewer-plugin,com.atlassian.jira.jira-fileviewer-plugin,com.atlassian.jira.jira-issue-nav-plugin,com.atlassian.crowd.user-provisioning-vertigo-plugin,com.atlassian.pas,com.atlassian.auiplugin,com.atlassian.jira.plugins.jira-development-integration-plugin,com.pyxis.greenhopper.jira_batch_file_eval:end');} catch(e){};